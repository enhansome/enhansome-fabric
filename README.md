...
* [Fabric API](https://github.com/FabricMC/fabric) ⭐ 3,177 | 🐛 208 | 🌐 Java | 📅 2026-09-22 [`🏰`](https://modrinth.com/mod/fabric-api) `🔝 26.3 / 26.4-snapshot-1` - Essential hooks and patches for modding with Fabric. ([Wiki](https://docs.fabricmc.net/) · [Old Wiki](https://fabricmc.net/wiki)) `Apache-2.0`
...
* [oωo (owo-lib)](https://github.com/glisco03/owo-lib) ⭐ 270 | 🐛 98 | 🌐 Java | 📅 2026-08-19 [`🏰`](https://modrinth.com/mod/owo-lib) `🔝 26.2` - A general utility library for content-focused modding on Fabric. ([Wiki](https://docs.wispforest.io/owo/setup)) `MIT`
...
* [The Sisterhood of Amecs](https://github.com/Siphalor/amecs) ⭐ 39 | 🐛 40 | 🌐 Java | 📅 2026-09-19 [`🏰`](https://modrinth.com/mod/amecs) `🔝 26.2` - Various key binding related features such as key modifiers, multiple shortcuts per binding, priority key bindings or key binding descriptions `Apache-2.0`
...
* [GeckoLib](https://github.com/bernie-g/geckolib) ⭐ 835 | 🐛 10 | 🌐 Java | 📅 2026-09-22 [`🏰`](https://modrinth.com/mod/geckolib) `🔝 26.3` - Forward kinematic gui-based animation engine. ([Wiki](https://github.com/bernie-g/geckolib/wiki/Getting-Started) ⭐ 835 | 🐛 10 | 🌐 Java | 📅 2026-09-22) `LGPL-3.0-only`
