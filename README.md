...
* [Fabric API](https://github.com/FabricMC/fabric) ⭐ 3,157 | 🐛 211 | 🌐 Java | 📅 2026-08-27 [`🏰`](https://modrinth.com/mod/fabric-api) `🔝 26.2 / 26.3-snapshot-10` - Essential hooks and patches for modding with Fabric. ([Wiki](https://docs.fabricmc.net/) · [Old Wiki](https://fabricmc.net/wiki)) `Apache-2.0`
...
* [Patchouli](https://github.com/VazkiiMods/Patchouli/) ⭐ 382 | 🐛 219 | 🌐 Java | 📅 2026-07-10 [`🏰`](https://modrinth.com/mod/patchouli) `🔝 26.1.2` - A mod that aims to provide easy to implement, data-driven documentation for minecraft modders and modpack makers alike. ([Wiki]()) `BY-NC-SA 3.0`
...
* [Polymer](https://github.com/Patbox/polymer) ⭐ 422 | 🐛 17 | 🌐 Java | 📅 2026-08-22 [`🏰`](https://modrinth.com/mod/polymer) `🔝 26.2` - A collection of libraries allowing more seamlessly developing mods that run server-side only. ([Wiki](https://polymer.pb4.eu/latest/)) `LGPL-3.0-only`

### Visual, Models, Rendering & Animation

* [GeckoLib](https://github.com/bernie-g/geckolib) ⭐ 830 | 🐛 10 | 🌐 Java | 📅 2026-08-30 [`🏰`](https://modrinth.com/mod/geckolib) `🔝 26.2` - Forward kinematic gui-based animation engine. ([Wiki](https://github.com/bernie-g/geckolib/wiki/Getting-Started) ⭐ 830 | 🐛 10 | 🌐 Java | 📅 2026-08-30) `LGPL-3.0-only`
