...
* [Official Wiki](https://github.com/SpongePowered/Mixin/wiki) ⭐ 1,710 | 🐛 113 | 🌐 Java | 📅 2024-08-05 - Contains some in-depth technical information, but is also missing a lot of topics.
* [MixinExtras Wiki](https://github.com/LlamaLad7/MixinExtras/wiki) ⭐ 447 | 🐛 15 | 🌐 Java | 📅 2026-08-12 - MixinExtras is nowadays included in Fabric loader, so you can use all of it out of the box.
...
* [Fabric API](https://github.com/FabricMC/fabric) ⭐ 3,144 | 🐛 209 | 🌐 Java | 📅 2026-08-24 [`🏰`](https://modrinth.com/mod/fabric-api) `🔝 26.2 / 26.3-snapshot-9` - Essential hooks and patches for modding with Fabric. ([Wiki](https://docs.fabricmc.net/) · [Old Wiki](https://fabricmc.net/wiki)) `Apache-2.0`
...
* [Cloth Config](https://github.com/shedaniel/ClothConfig/) ⭐ 257 | 🐛 148 | 🌐 Java | 📅 2026-06-18 [`🏰`](https://modrinth.com/mod/cloth-config) `🔝 26.2` - A full-fledged, annotation-based configuration library. ([Wiki](https://shedaniel.gitbook.io/cloth-config/)) `Apache-2.0`
...
* [SpruceUI](https://github.com/LambdAurora/SpruceUI) ⭐ 185 | 🐛 7 | 🌐 Java | 📅 2026-06-11 - Utilities for creating GUIs. `MIT`
...
* [GeckoLib](https://github.com/bernie-g/geckolib) ⭐ 828 | 🐛 10 | 🌐 Java | 📅 2026-07-01 [`🏰`](https://modrinth.com/mod/geckolib) `🔝 26.2` - Forward kinematic gui-based animation engine. ([Wiki](https://github.com/bernie-g/geckolib/wiki/Getting-Started) ⭐ 828 | 🐛 10 | 🌐 Java | 📅 2026-07-01) `LGPL-3.0-only`
