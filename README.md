...
* [Official Wiki](https://github.com/SpongePowered/Mixin/wiki) ⭐ 1,720 | 🐛 113 | 🌐 Java | 📅 2024-08-05 - Contains some in-depth technical information, but is also missing a lot of topics.
...
* [Fabric API](https://github.com/FabricMC/fabric) ⭐ 3,166 | 🐛 203 | 🌐 Java | 📅 2026-09-09 [`🏰`](https://modrinth.com/mod/fabric-api) `🔝 26.2 / 26.3-pre-3` - Essential hooks and patches for modding with Fabric. ([Wiki](https://docs.fabricmc.net/) · [Old Wiki](https://fabricmc.net/wiki)) `Apache-2.0`
